                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="min-w-full">
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Slug</th>
                                    ...
                                    <td class="px-6 py-5">
                                        @if($category->image)
                                            <img src="{{ asset('storage/'.$category->image) }}"
                                                 class="h-14 w-16 rounded-lg border border-gray-200 object-cover dark:border-gray-700"
                                                 alt="Category Image">
                                        @else
